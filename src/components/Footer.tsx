        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-6">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/industries/ai" className="text-sm text-[#322F2D]/50 transition-colors hover:text-[#1A1817]">AI Agents</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="https://github.com/brik64" target="_blank" rel="noopener noreferrer" className="text-sm text-[#322F2D]/50 transition-colors hover:text-[#1A1817]">GitHub <ExtIcon /></a></li>
              <li><a href="https://x.com/brik64" target="_blank" rel="noopener noreferrer" className="text-sm text-[#322F2D]/50 transition-colors hover:text-[#1A1817]">X / Twitter <ExtIcon /></a></li>
              <li><a href="https://medium.com/@brik64" target="_blank" rel="noopener noreferrer" className="text-sm text-[#322F2D]/50 transition-colors hover:text-[#1A1817]">Medium <ExtIcon /></a></li>
              <li><a href="https://discord.gg/brik64" target="_blank" rel="noopener noreferrer" className="text-sm text-[#322F2D]/50 transition-colors hover:text-[#1A1817]">Discord <ExtIcon /></a></li>
            </ul>
          </div>
        </div>
