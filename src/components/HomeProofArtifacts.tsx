  ...
  return (
    <ArtifactFrame>
      <ArtifactHeader
        ...
        title="Mainstream languages optimize expression. BRIK64 optimizes certifiable structure."
        description="The problem is not syntax taste. The problem is that open, unconstrained systems let invalid states survive until production."
