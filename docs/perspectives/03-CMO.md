...
> Status note: this document is now a supporting perspective, not the master
> strategy source.
>
> Canonical source:
> `docs/brik_64_final_positioning_brand_web_cmo_system.md`
>
> Use this file for historical reasoning, rollout ideas, and campaign texture.
> When wording, positioning, buyer framing, or web narrative conflicts with the
> canonical source, align this document to the canonical source instead of the
> reverse.
